...
#==============================================================
#Importamos lo necesario para la traduccion de C
import C.Analizador as Analisis
#==============================================================
...
def ejec_ascendente():
    ...
    ejecucion_automatica=1
    cont=contenedorEditor.Editor().get("1.0",END)
    waitForCommand=0
...
def iniciar_debug():
    ...
    no_instruccion=0
    # Inter.inicializarGUI(editor,consola)
    Inter.inicializarGUI(contenedorEditor.Editor(),consola)
    Inter.limpiarValores()
...
menubar.add_cascade(label="Augus", menu=ejecutarmenu)
menubar.add_cascade(label="MinorC", menu=ejecutarMinorC)
